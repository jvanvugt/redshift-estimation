...
def get_data():
    ...
    print 'after missing data:', len(X)
    print y
    return X, y
...
def classification_info(predictions, labels, plotting):
    """
...
def regressor_info(predictions, actual, plotting):
    """
...
def classify(X_train, X_test, y_train, y_test, plotting):
    """
    ...
    classification_info(predictions_clf, y_test, plotting)
    print
    return predictions_clf

def regress(X_train, X_test, y_train, y_test, plotting):
    """
    ...
    regressor_info(predictions_regressor, y_test, plotting)

def run(plotting=True):
    """
    ...
    classify(X_train, X_test, class_train, class_test, plotting)
    ...
    regress(X_qso_train, X_qso_test, redshift_qso_train, redshift_qso_test, plotting)
